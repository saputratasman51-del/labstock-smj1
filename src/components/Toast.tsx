...
export function ToastStack({ toasts }: { toasts: Toast[] }) {
  return (
    <div className="pointer-events-none fixed bottom-5 right-5 z-[100] flex w-[min(92vw,370px)] flex-col gap-space-sm">
      {toasts.map((t) => {
        ...
        return (
          <div
            key={t.id}
            className="pointer-events-auto relative flex animate-toast-in items-start gap-space-md overflow-hidden rounded-lg bg-surface-container-lowest p-space-md pr-space-base shadow-pop ring-1 ring-on-surface/5"
            role="status"
          >
